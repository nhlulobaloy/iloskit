...
if (empty($cart)) {
    ...
    <body>
        <div class="empty-cart-container">
            ...
            <a href="index.php" class="btn btn-primary btn-shopping">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <form action="remove_from_cart.php" method="post" onsubmit="return confirm('Are you sure you want to remove this item?');">
        ...
        <div class="row mt-4">
            <div class="col-md-5 ms-auto">
                    ...
                    <form action="apply_promo.php" method="POST">
                        <div class="input-group">
                            <input type="text" name="promo_code" class="form-control" 
                                   ...
                                   value="<?= $_SESSION['applied_promo']['code'] ?? '' ?>">
                ...
                <div class="cart-total">
                    ...
                    <?php if (isset($_SESSION['applied_promo'])): ?>
                    <div class="d-flex justify-content-between mb-2 discount-text">
                        <span class="fw-bold">Discount (<?= $_SESSION['applied_promo']['code'] ?>):</span>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <h5 class="fw-bold">R<?= number_format($grandTotal, 2) ?></h5>
                    </div>
                </div>

                <div class="d-flex justify-content-between mt-4">
                    <a href="index.php" class="btn btn-outline-secondary btn-continue">
